...
public class FirebaseDBReadActivity extends AppCompatActivity implements AdapterBarangRecycleView.FirebaseDataListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        database.child("barang").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                 ...
                 */
                adapter = new AdapterBarangRecycleView(daftarBarang, FirebaseDBReadActivity.this);
